...
//invalid username
	...
	public void user_enters_invalid_username_but_valid_password_and_confirm_password(String sheetname, Integer rownum)
			throws IOException {
		LinkedHashMap<String, String> testData = excelReader.getTestData(sheetname, rownum);
		this.username = testData.get("Username");
		this.password = testData.get("Password");
...
//valid username but invalid password
	...
	public void user_enters_valid_username_but_invalid_password_and_confirm_password(String sheetname, Integer rownum)
			throws IOException {
		LinkedHashMap<String, String> testData = excelReader.getTestData(sheetname, rownum);
		this.username = testData.get("Username");
		this.password = testData.get("Password");
...
//pwd and confirm pwd is different
	...
	public void user_enters_valid_username_and_valid_but_different_password_confirm_password_values_and(
...
//already registered user
	...
	public void user_enters_valid_username_password_confirm_password_values_of_an_already_registered_user_and(
			String sheetname, Integer rownum) throws IOException {
		LinkedHashMap<String, String> testData = excelReader.getTestData(sheetname, rownum);
		this.username = testData.get("Username");
		this.password = testData.get("Password");
...
//valid user registration
	...
	public void user_enters_valid_username_password_password_confirmation_values_register_page(String sheetname,
			Integer rownum) throws IOException {
